...
**Дата:** 2026-07-14  
**Объект:** [`Documents/fira/FIRA.md`](./fira/FIRA.md) (v0.3) + компонентные спеки FIRA-F/P/C/M; as-built C# (Phase 0 / v1.1-гигиена); Rust-порт скореров; golden-векторы  
...
| Векторы | `Documents/test-vectors/fira/*.json`, C# freeze-контроль, `Backend/Tests/parity/tests/fira_vectors.rs` |
...
Пункты 1–3 **не** требуют регенерации golden-векторов и совместимы с уже снятыми `Documents/test-vectors/fira/*`.

---

## Связанные артефакты

- Норма: [`Documents/fira/FIRA.md`](./fira/FIRA.md), [`FIRA-F.md`](./fira/FIRA-F.md), [`FIRA-P.md`](./fira/FIRA-P.md), [`FIRA-C.md`](./fira/FIRA-C.md), [`FIRA-M.md`](./fira/FIRA-M.md)
- Векторы: [`Documents/test-vectors/fira/`](./test-vectors/fira/), [`Documents/test-vectors/README.md`](./test-vectors/README.md)
- Миграция: [`next-architecture.md`](../next-architecture.md) §6 (Фазы 1 / 2b / 3), §7 (golden / differential)
- FGP: [`Documents/fgp/FGP.md`](./fgp/FGP.md) (суверенитет рекомендаций, anti-capture)
