...
Общий Jwt: `.flora/dev-jwt.secret` (`Scripts/ensure-shared-dev-jwt.ps1`). Music workers и Auth (sessions + logout) только на gateway (`Music:ServeNative` / `Auth:ServeNative`).
