...
/// Параметры кодерной эвристики адаптивной квантизации v9/v10 (свобода
/// кодера: декодер читает любые сигналённые ступени; калибровка —
/// полигон §11.5/§11.6).
#[derive(Clone, Copy)]
pub struct DqTuning {
    /// Ступеней delta-Q на октаву активности; 0 — AQ выключена.
    pub strength: f32,
    /// Масштаб силы для положительных отклонений (огрубление текстур),
    /// v10: сила вверх = `strength * up_scale`. 1.0 — симметрия (v9).
    pub up_scale: f32,
