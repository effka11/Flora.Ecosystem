...
impl fmt::Display for DecodeError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::NotFrcI => write!(f, "не FRC-I-поток (magic не совпал)"),
            Self::UnsupportedVersion(v) => write!(f, "версия FRC-I {v} не поддерживается"),
