...
{
    /// <inheritdoc />
    public partial class AddUserMessageVideoAssets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "user_message_video_assets",
                schema: "flora_core",
                columns: table => new
                {
                    video_asset_uuid = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_message_video_assets", x => x.video_asset_uuid);
                    table.ForeignKey(
                        name: "fk_user_message_video_assets_message",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_message_video_assets_message_uuid",
                schema: "flora_core",
                table: "user_message_video_assets",
                column: "message_uuid");

            migrationBuilder.CreateIndex(
                name: "ix_user_message_video_assets_peer_created",
                schema: "flora_core",
                table: "user_message_video_assets",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_message_video_assets_receiver_user_uuid",
                schema: "flora_core",
                table: "user_message_video_assets",
                column: "receiver_user_uuid");

            migrationBuilder.CreateIndex(
                name: "ix_user_message_video_assets_sender_user_uuid",
                schema: "flora_core",
                table: "user_message_video_assets",
