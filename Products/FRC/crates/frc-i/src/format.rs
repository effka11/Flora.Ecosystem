...
/// корней сильнее огрубления текстур. Публичный lossy-кодер пишет v10.
pub const VERSION_ASYMMETRIC_AQ: u8 = 10;
/// Максимальная версия, которую читает этот декодер.
pub const VERSION_MAX: u8 = VERSION_ASYMMETRIC_AQ;
...
pub struct Header {
    /// Версия битстрима (1..=10); раскладка заголовка у всех одинаковая.
    pub version: u8,
    pub width: u32,
    pub height: u32,
    pub lossless: bool,
