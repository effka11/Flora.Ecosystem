...
Message franking v1 (Documents/fscp/franking.md): commitInput -> HMAC-SHA-256 frankTag ->
...
def main() -> None:
    ...
    out = {
        ...
        "frankingVersion": 1,
        "description": (
            "Message franking v1 (FSCP-FRANK, Documents/fscp/franking.md): commit -> tag -> receipt -> "
