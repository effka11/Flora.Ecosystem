...
//! Нормативная спецификация битстрима — `docs/codecs/FIC.md`. Кодер пишет v3;
//! декодер читает v1..v3 (старые версии заморожены golden-векторами в `tests/`).
//!
...
/// Кодирует изображение в FIC (текущая версия битстрима — v3).
