# Flora Android — USB Metro dev-client (adb reverse 8081 + 5290 API).
# PowerShell 5.1 safe: no && in strings.
# USB: app loads JS from http://127.0.0.1:8081 via adb reverse (not Wi-Fi LAN IP).
# Full stack (DB + flora-api + install + Metro): mobile-debug-android.ps1
...
Write-Host "================================================================"
Write-Host "Metro: 127.0.0.1:8081 (USB / adb reverse). API: flora-api :5290."
