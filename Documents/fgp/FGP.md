...
Сегодняшняя юридическая реальность ([`LEGAL.md`](../../LEGAL.md)): единый правообладатель, CLA с делегированием прав, двойное лицензирование кода (AGPL-3.0-only | коммерческая лицензия на Flora Ecosystem), CC BY-SA 4.0 для спецификаций, охраняемые обозначения (включая «FGP»). Из этого следует:
