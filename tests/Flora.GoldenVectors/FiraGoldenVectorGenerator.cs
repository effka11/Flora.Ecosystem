...
/// Трансцендентные функции (ln/exp/tanh) могут расходиться на ~1 ulp между libm-реализациями —
/// freeze-тест и Rust consumer сравнивают score с относительным допуском 1e-12,
/// порядок ранжирования — точно.
/// </summary>
