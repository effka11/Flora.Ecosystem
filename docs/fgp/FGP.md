...
Компаньон: [`FGP-THREATS.md`](./FGP-THREATS.md) (v0.2) — модель противников, операционные программы защиты (V-01…V-13), красная команда, симуляции, лестница деградации, кризисные процедуры, исследовательские треки. Оба документа нормативны; при конфликте приоритет у `FGP.md`. История адверсариальных ревью — Приложение B (B.1: 0.1 → 0.2, 25 находок; B.2: 0.2 → 0.3, ещё 25).
...
- Перечислены закрыто: деплой и параметры v0, назначение первых витнессов журнала, календарь учредительных событий. Всё исполняется с меткой `genesis` в журнале; первая запись журнала — хеш этого документа.
...
## 10. Prior art: что взято и что отвергнуто
