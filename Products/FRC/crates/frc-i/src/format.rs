...
/// (целочисленный Q6). Дерево блоков, энтропия и цвет — как в v8.
...
pub const VERSION_MAX: u8 = VERSION_PERCEPTUAL;
...
pub struct Header {
    /// Версия битстрима (1..=9); раскладка заголовка у всех одинаковая.
    pub version: u8,
    pub width: u32,
    pub height: u32,
    pub lossless: bool,
