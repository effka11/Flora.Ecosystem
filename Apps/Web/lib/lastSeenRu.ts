...
/**
 * Фраза «Был в сети …» для подписи под именем в чате (когда собеседник не онлайн).
 * Возвращает null, если дата неизвестна или не парсится.
 */
export function formatWasOnlineRu(lastSeenIso: string | null | undefined, now: Date = new Date()): string | null {
