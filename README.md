...
**Luna Ecosystem**  –  отдельная коммерческая лицензия для закрытой интеграции кода в чужой продукт. Это не отмена AGPL для пользовательской Flora и не «закрытие» соцсети для сообщества.

Подробности: [`LEGAL.md`](LEGAL.md), [`LICENSE`](LICENSE), [`LICENSE-COMMERCIAL.md`](LICENSE-COMMERCIAL.md), [`NOTICE.md`](NOTICE.md). Некодовые материалы  –  **CC BY-SA 4.0** или коммерческая лицензия через Luna ([`LICENSE-CONTENT.md`](LICENSE-CONTENT.md)).
