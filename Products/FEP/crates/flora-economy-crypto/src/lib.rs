...
//!
//! FEP — валюта **Pollen** (единица `pollen`, атом `grain`), спроектированная как пост-дефицитная,
...
//! репутацию или personhood. Pollen покупает товары/услуги/общее — и только. Governance-домен
//! (FGP) задаёт параметры FEP решением класса R2, но не может купить за Pollen ни грамма власти,
...
pub use amount::{AccountId, Grains, POLLEN_IN_GRAINS, Timestamp};
