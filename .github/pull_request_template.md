...
- [ ] **CLA:** я прочитал(а) и принимаю [CLA — CONTRIBUTING.md, раздел 1](https://github.com/effka11/Flora.Ecosystem/blob/main/CONTRIBUTING.md#1-лицензионное-соглашение-контрибьютора--cla-обязательно), включая право двойного лицензирования моего Вклада (GNU AGPLv3 / CC BY-SA 4.0 + коммерческие лицензии Luna Ecosystem)
